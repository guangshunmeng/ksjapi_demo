...
public:
	...
	afx_msg void OnBnClickedCheckPreviewFfc();
	afx_msg void OnBnClickedCheckCaptureFfc();
	afx_msg void OnBnClickedButtonMakeDarkFrame();
	afx_msg void OnBnClickedButtonMakeFlatFieldFrames();

private:
	void UpdateInterfaceFFC();
	void MessageErrorInfo(int nRet);
public:
