...
{
	TCHAR   szBuf[128] = {'\0'};
	sprintf_s(szBuf, _T("Capture %04d Frames and Use %08dB (%0.2fKB, %0.2fMB)  Memory For Record"), nRecordFramesNum, nRecordBufferBytes, (float)(nRecordBufferBytes / 1024.0f), (float)(nRecordBufferBytes / 1024.0f / 1024.0f));
...
void CKSJDemoVCDlg::OnBnClickedCheckRecordStart()
{
	...
	GetLocalTime(&LocalTime);
#ifdef _WIN64
	sprintf_s(szFileName, _T("capture-%04d-%02d-%02d-%02d-%02d-%02d-%03d-64.avi"), LocalTime.wYear, LocalTime.wMonth, LocalTime.wDay, LocalTime.wHour, LocalTime.wMinute, LocalTime.wSecond, LocalTime.wMilliseconds);
#else
	sprintf_s(szFileName, _T("capture-%04d-%02d-%02d-%02d-%02d-%02d-%03d-32.avi"), LocalTime.wYear, LocalTime.wMonth, LocalTime.wDay, LocalTime.wHour, LocalTime.wMinute, LocalTime.wSecond, LocalTime.wMilliseconds);
#endif
